...
map <leader>g :vimgrep // ./**/*.coffee<left><left><left><left><left><left><left><left><left><left><left><left><left><left><left>
...
function! VisualSelection(direction) range
    ...
    elseif a:direction == 'gv'
        call CmdLine("vimgrep " . '/'. l:pattern . '/' . ' ./**/*.coffee')
